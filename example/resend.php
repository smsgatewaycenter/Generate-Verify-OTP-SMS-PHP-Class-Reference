...
/**
 * SMSGatewayCenter - Resend OTP SMS 
 *
...
*/
$smsgatewaycenter->setMobile("919xxxxxxxxx"); //Your customer's mobile number with country code
...
$smsgatewaycenter->setRenew("true"); // Set to true to renew/resend new otp
